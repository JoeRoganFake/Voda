...
class _RemindersSection extends StatelessWidget {
  ...
  static const _intervals = [1, 2, 3, 4];

  Future<void> _toggle(
      BuildContext context, WaterProvider water, bool enable) async {
    if (enable) {
      ...
      await NotificationService.scheduleReminders(
          intervalHours: water.reminderIntervalHours);
    } else {
  ...
  Future<void> _setInterval(WaterProvider water, int hours) async {
    await water.setReminderIntervalHours(hours);
    if (water.remindersEnabled) {
      await NotificationService.scheduleReminders(intervalHours: hours);
    }
  }
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      enabled
                          ? 'Každé ${water.reminderIntervalHours} hod. (8:00 – 22:00)'
              ...
              Switch(
                value: enabled,
                onChanged: (val) => _toggle(context, water, val),
          ...
          if (enabled) ...[
            ...
            Row(
              children: _intervals.map((h) {
                final selected = water.reminderIntervalHours == h;
                return Expanded(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 3),
                    child: GestureDetector(
                      onTap: () => _setInterval(water, h),
                      child: AnimatedContainer(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color:
                                selected ? const Color(0xFF4ADE80) : Colors.white60,
                            fontWeight: selected
                                ? FontWeight.bold
                                : FontWeight.normal,
                            fontSize: 13,
