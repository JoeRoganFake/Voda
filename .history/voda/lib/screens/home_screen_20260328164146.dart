...
class _QuickActionsRow extends StatelessWidget {
  final double progress;
  const _QuickActionsRow({required this.progress});

  @override
  Widget build(BuildContext context) {
    final water = context.watch<WaterProvider>();
    final isUnderwater = progress > 0.65;
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w600,
              color: isUnderwater ? Colors.white : const Color(0xFF475569),
            ),
          ),
              ...
              boxShadow: [
                BoxShadow(
                  color: (isCustom ? const Color(0xFF0EA5E9) : Colors.black)
                      .withOpacity(isUnderwater ? 0.1 : 0.08),
                  blurRadius: 12,
