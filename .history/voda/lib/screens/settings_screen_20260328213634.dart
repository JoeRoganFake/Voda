...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  // _showGoalCalculator removed — now navigates to GoalCalculatorScreen

  void _confirmReset_placeholder() {}
  // placeholder above removed in next replace
  void _showGoalCalculator_placeholder(BuildContext context) {
