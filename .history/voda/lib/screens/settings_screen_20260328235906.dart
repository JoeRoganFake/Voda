...
class _RemindersSectionState extends State<_RemindersSection> {
  // Local slider state to avoid Provider rebuilds while dragging.
  ...
  void initState() {
    super.initState();
    _sliderValue =
        context.read<WaterProvider>().reminderIntervalMinutes.toDouble();
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      enabled
                          ? 'Každých ${_formatMinutes(currentMinutes)} (8:00 – 22:00)'
