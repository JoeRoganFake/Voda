...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    // Check for any notice that was set while HomeScreen didn't exist (splash).
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _showPendingNotice();
      // If auto-adjust is on, trigger a fresh weather fetch so the goal
      // updates and the user sees a popup when data arrives.
      final w = context.read<WaterProvider>();
      final c = context.read<ClimateProvider>();
      if (w.autoClimateAdjust) {
